#!/usr/bin/env python3
"""
Main entry point for UNetbootin Python rewrite using PySimpleGUI.
This is the lightweight version without Qt dependencies.
"""
...
def main():
    ...
    from unetbootin.app_pysg import UNetbootinAppPySG
