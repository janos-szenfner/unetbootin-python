"""Resources package for PyNetboot.
...
def _base_dirs():
    ...
    if getattr(sys, 'frozen', False):
        ...
        if meipass:
            ...
            candidates.append(meipass / 'pynetboot' / 'resources')
            ...
            candidates.append(resources_dir / 'pynetboot' / 'resources')
        ...
        candidates.append(exe_dir / 'pynetboot' / 'resources')
        candidates.append(exe_dir.parent / 'Resources' / 'pynetboot' / 'resources')
    # Normal layout: this file lives at <pkg>/pynetboot/resources/__init__.py
